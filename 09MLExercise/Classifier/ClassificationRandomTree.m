...
classdef ClassificationRandomTree
    ...
    methods
        ...
        % constructor
        function obj = ClassificationRandomTree(input_dim, nbClasses, treeDepth, ntry)
        ...
        function obj = performSplitting(obj,X,Y,treeDepth,nodes_count,parent,leftright)
            ...
            if(treeDepth>1)
                ...
                %- for median thresholds uncomment this -%
                %dim_idx = randperm(D);
                %dim_idx = dim_idx(1:obj.Ntry);
                
                %- for random thresholds uncomment this -%
                ...
                %- to generate median splits uncomment this -%
                %thr = median(xx,1);
                
                %- to generate random thresholds uncomment this -%
                Xmin = min(xx,[],1);
                Xmax = max(xx,[],1);
                ...
                for i=1:obj.Ntry
                    ...
                    if(NbPointsL>obj.PopulationPerLeaf && NbPointsR>obj.PopulationPerLeaf)
						...
						% we compute the posteriors normalized by the class prior
